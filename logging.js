...
function sendNetworkLog(
  ...
  state,
  log_version) {
  var formid = "e/1FAIpQLScpf8xpogqZ-_vqcY-5UdDp2B0kL8opKQlKQZKJvI18zuwLyA";
  var data = {
    "entry.941182518": uid,
    "entry.1554172236": time,
    "entry.836419682": eventname,
    "entry.382407083": target,
    "entry.1503696414": info,
    "entry.1963956873": state,
    "entry.1643799391": log_version
  };
  var params = [];
  for (key in data) {
